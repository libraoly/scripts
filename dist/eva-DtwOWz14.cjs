...
unstorage_drivers_fs = require_sleep.__toESM(unstorage_drivers_fs, 1);
...
function createFileStorage(options = {}) {
	const base = options.base ?? require_sleep.useEnv("STORAGE_BASE_DIR", "./.data");
	return (0, unstorage.createStorage)({ driver: (0, unstorage_drivers_fs.default)({
		base,
		...options
	}) });
}
...
async function fetchEvaStock(options) {
	const { skuId: rawSkuId, provinceId = DEFAULT_PROVINCE_ID, cityId = DEFAULT_CITY_ID, regionId = DEFAULT_REGION_ID, timeout = 30, retries = 3, backoff = 2, headers, baseUrl = BASE_URL, client = require_sleep.httpClient, kyOptions } = options;
	const skuId = String(rawSkuId ?? "").trim();
	if (!skuId) throw new Error("[fetchEvaStock] Missing required parameter: \"skuId\"");
	const itemId = String(options.itemId ?? require_sleep.useEnv("EVA_ITEM_ID", "5310000100239002"));
	const userId = options.userId ?? require_sleep.useEnv("EVA_USER_ID", "");
	const appCode = options.appCode ?? require_sleep.useEnv("EVA_APP_CODE", "3fa3314998bd4195a9fe2df3e85e6a12");
	const token = options.token ?? require_sleep.useEnv("EVA_TOKEN", "");
	const queryParams = {
		provinceId,
		cityId,
		regionId,
	...
	const targetUrl = `${baseUrl}?${require_sleep.toURLSearchParams(queryParams).toString()}`;
...
function determineStockEvent(current, previous, options = {}) {
	...
	const formattedTime = (0, date_fns.format)(targetDate, "yyyy-MM-dd HH:mm:ss");
...
const logger = consola.default.withTag("Eva");
/**
...
Object.defineProperty(exports, "DEFAULT_APP_CODE", {
	enumerable: true,
	get: function() {
		return DEFAULT_APP_CODE;
	}
});
Object.defineProperty(exports, "DEFAULT_BARK_GROUP", {
	enumerable: true,
	get: function() {
		return DEFAULT_BARK_GROUP;
	}
});
Object.defineProperty(exports, "DEFAULT_BARK_LEVEL", {
	enumerable: true,
	get: function() {
		return DEFAULT_BARK_LEVEL;
	}
});
Object.defineProperty(exports, "DEFAULT_BARK_TITLE", {
	enumerable: true,
	get: function() {
		return DEFAULT_BARK_TITLE;
	}
});
Object.defineProperty(exports, "DEFAULT_CITY_ID", {
	enumerable: true,
	get: function() {
		return DEFAULT_CITY_ID;
	}
});
Object.defineProperty(exports, "DEFAULT_HEADERS", {
	enumerable: true,
	get: function() {
		return DEFAULT_HEADERS;
	}
});
Object.defineProperty(exports, "DEFAULT_ITEM_ID", {
	enumerable: true,
	get: function() {
		return DEFAULT_ITEM_ID;
	}
});
Object.defineProperty(exports, "DEFAULT_JUMP_URL", {
	enumerable: true,
	get: function() {
		return DEFAULT_JUMP_URL;
	}
});
Object.defineProperty(exports, "DEFAULT_PROVINCE_ID", {
	enumerable: true,
	get: function() {
		return DEFAULT_PROVINCE_ID;
	}
});
Object.defineProperty(exports, "DEFAULT_RAPID_CHANGE_THRESHOLD", {
	enumerable: true,
	get: function() {
		return DEFAULT_RAPID_CHANGE_THRESHOLD;
	}
});
Object.defineProperty(exports, "DEFAULT_REGION_ID", {
	enumerable: true,
	get: function() {
		return DEFAULT_REGION_ID;
	}
});
Object.defineProperty(exports, "EVA_APP_CODE_ENV_NAME", {
	enumerable: true,
	get: function() {
		return EVA_APP_CODE_ENV_NAME;
	}
});
Object.defineProperty(exports, "EVA_ITEM_ID_ENV_NAME", {
	enumerable: true,
	get: function() {
		return EVA_ITEM_ID_ENV_NAME;
	}
});
Object.defineProperty(exports, "EVA_SKU_MAP", {
	enumerable: true,
	get: function() {
		return EVA_SKU_MAP;
	}
});
Object.defineProperty(exports, "EVA_STORAGE_PREFIX", {
	enumerable: true,
	get: function() {
		return EVA_STORAGE_PREFIX;
	}
});
Object.defineProperty(exports, "EVA_TOKEN_ENV_NAME", {
	enumerable: true,
	get: function() {
		return EVA_TOKEN_ENV_NAME;
	}
});
Object.defineProperty(exports, "EVA_USER_ID_ENV_NAME", {
	enumerable: true,
	get: function() {
		return EVA_USER_ID_ENV_NAME;
	}
});
Object.defineProperty(exports, "TITLE_IN_STOCK", {
	enumerable: true,
	get: function() {
		return TITLE_IN_STOCK;
	}
});
Object.defineProperty(exports, "TITLE_NO_STOCK", {
	enumerable: true,
	get: function() {
		return TITLE_NO_STOCK;
	}
});
Object.defineProperty(exports, "TITLE_OUT_OF_STOCK", {
	enumerable: true,
	get: function() {
		return TITLE_OUT_OF_STOCK;
	}
});
Object.defineProperty(exports, "TITLE_RAPID_DECREASE", {
	enumerable: true,
	get: function() {
		return TITLE_RAPID_DECREASE;
	}
});
Object.defineProperty(exports, "TITLE_STOCK_INCREASED", {
	enumerable: true,
	get: function() {
		return TITLE_STOCK_INCREASED;
	}
});
Object.defineProperty(exports, "determineStockEvent", {
	enumerable: true,
	get: function() {
		return determineStockEvent;
	}
});
Object.defineProperty(exports, "fetchEvaStock", {
	enumerable: true,
	get: function() {
		return fetchEvaStock;
	}
});
Object.defineProperty(exports, "runEvaStockCheck", {
	enumerable: true,
	get: function() {
		return runEvaStockCheck;
	}
});
Object.defineProperty(exports, "shouldNotifySku", {
	enumerable: true,
	get: function() {
		return shouldNotifySku;
	}
});
